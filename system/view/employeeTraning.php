    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <h3>Registrer uttak</h3>
                    <p>Registrer uttak brukes når du skal ta ut et produkt fra lageret.</p>
                    <div class="col-md-12">
                    <img src="image/RegistrerUttak_1.PNG">
                    </div>
                </div>
                <div class="col-md-3">
                    <h3>Registrer retur</h3>
                    <p>Registrer retur brukes når du skal legge inn igjen et produkt på lager.</p>
                    <div class="col-md-12">
                    <img src="image/RegistrerRetur.PNG">
                    </div>
                </div>
                <div class="col-md-3">
                    <h3>Overføring</h3>
                    <p>Overføring brukes hvis du har tilgang til flere enn 1 lager. Her kan du flytte produkter mellom lager.</p>
                    <div class="col-md-12">
                    <img src="image/Overføring.PNG">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                    <img src="image/DineReturerNav.PNG">
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                    <img src="image/BrukerDropdown.PNG">
                    </div>
                </div>
