...
{{#each prodInfo}} 
    <tr class="selectQuantity">
        ...
        <th>Antall:</th>
        <td><input id="{{productID}}" data-id="{{macAdresse}}" class="form-control negativeSupport negativeSupport{{productID}}" name="withdrawQuantity[]" form="withdrawProducts" required="required" type="number" min="1" value="1" autocomplete="off"/></td> 
